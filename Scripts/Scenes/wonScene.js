...
var Scenes;
(function (Scenes) {
    var WonScene = (function (_super) {
        __extends(WonScene, _super);
        function WonScene() {
            var _this = _super.call(this) || this;
            _this.start();
            return _this;
        }
        WonScene.prototype.start = function () {
        ...
        // event handlers
        WonScene.prototype._playAgainBtn_Click = function (event) {
    ...
    Scenes.WonScene = WonScene;
})(Scenes || (Scenes = {}));
//# sourceMappingURL=wonScene.js.map